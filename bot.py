...
# =========================================================
# 💬 Start ခလုတ်နှိပ်လျှင် (Private Chat ကော Group မှာပါ အလုပ်လုပ်စေရန်)
# =========================================================
@bot.message_handler(commands=['start'])
def welcome_message(message):
    # --- တကယ်လို့ User က Bot ရဲ့ Private Chat ထဲမှာ လာနှိပ်တာဆိုလျှင် ---
    ...
    # --- တကယ်လို့ Group ထဲမှာ လာနှိပ်တာဆိုလျှင် (Inline Button အဖြစ် ပြောင်းပြမည်) ---
    else:
        inline_markup = types.InlineKeyboardMarkup()
        # 🚨 ခလုတ်နှိပ်လိုက်လျှင် Bot ၏ Private Chat ထဲသို့ တိုက်ရိုက် ခေါ်သွားမည့် လင့်ခ်
        btn_go_private = types.InlineKeyboardButton("🔑 သီးသန့် Password ယူရန် (နှိပ်ပါ)", url=f"https://t.me/{BOT_USERNAME}?start=true")
        btn_go_web = types.InlineKeyboardButton("🌐 ဝဘ်ဆိုက်သို့သွားရန်", url="https://paingttsmyanmar.onrender.com")
        inline_markup.add(btn_go_private)
        inline_markup.add(btn_go_web)
        
        group_text = (
            "📢 **Myanmar TTS & SRT Service** 📢\n\n"
            "ဆော့ဖ်ဝဲလ် အသုံးပြုရန်အတွက် အောက်ပါခလုတ်ကိုနှိပ်၍ **Bot ၏ Private Chat တွင်** Password ကို လုံခြုံစွာ ရယူနိုင်ပါပြီဗျာ။ 👇"
        )
